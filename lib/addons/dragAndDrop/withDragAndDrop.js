  ...
  var DragAndDropCalendar =
    ...
    (function(_React$Component) {
      ...
      function DragAndDropCalendar() {
        ...
        _this.handleLockDropFromOutside = function(lock) {
          _this.setState({
        ...
        _this.handleInteractionEnd = function(interactionInfo, eventSafe) {
          if (eventSafe === void 0) {
            eventSafe = false
          }
          ...
          _this.setState({
            action: eventSafe ? action : null,
            event: eventSafe ? event : null,
            interacting: false,
            direction: null,
