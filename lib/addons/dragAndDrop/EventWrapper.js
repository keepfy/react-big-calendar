...
var EventWrapper =
  ...
  (function(_React$Component) {
    ...
    _proto.render = function render() {
      ...
      if (this.props.view === _index.Views.MONTH) return children
      var _this$context$draggab = this.context.draggable,
        draggable =
          _this$context$draggab === void 0 ? {} : _this$context$draggab
      var _draggable$draggableA = draggable.draggableAccessor,
        draggableAccessor =
          _draggable$draggableA === void 0 ? null : _draggable$draggableA,
        _draggable$resizableA = draggable.resizableAccessor,
        resizableAccessor =
          _draggable$resizableA === void 0 ? null : _draggable$resizableA
