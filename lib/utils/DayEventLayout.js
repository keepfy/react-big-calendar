...
var Event =
  /*#__PURE__*/
  (function() {
    function Event(data, _ref, canOverlap) {
    ...
    ;(0, _createClass2.default)(Event, [
      ...
      },
      {
        ...
        get: function get() {
          ...
          var growFactor = this.canOverlap ? 1.7 : 1
          var overlap = Math.min(100, this._width * growFactor) // Containers can always grow.
...
function getStyledEvents(_ref2) {
  var events = _ref2.events,
    ...
    canOverlapEvents = _ref2.canOverlapEvents
